...
class CreateVacationRequestUseCaseTest {
    ...
    void savesRequestStartsProcessAndPersistsProcessInstanceId() {
        ...
        InOrder inOrder = inOrder(saveVacationRequestOutPort, startVacationApprovalProcessOutPort);
        ...
        inOrder.verify(saveVacationRequestOutPort).save(any(VacationRequest.class));
        verifyNoMoreInteractions(saveVacationRequestOutPort, startVacationApprovalProcessOutPort);
