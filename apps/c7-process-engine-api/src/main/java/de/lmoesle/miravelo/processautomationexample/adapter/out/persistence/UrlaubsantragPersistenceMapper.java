...
import de.lmoesle.miravelo.processautomationexample.adapter.out.persistence.entities.UrlaubsantragStatusHistorieneintragEmbeddable;
...
import de.lmoesle.miravelo.processautomationexample.domain.urlaubsantrag.Urlaubszeitraum;
    ...
    public static Urlaubsantrag toDomain(
        ...
        return new Urlaubsantrag(
            ...
            urlaubsantragEntity.getStatusHistorie().stream()
                ...
                .toList(),
            urlaubsantragEntity.getProzessinstanzId() == null ? null : de.lmoesle.miravelo.processautomationexample.domain.urlaubsantrag.ProzessinstanzId.of(
