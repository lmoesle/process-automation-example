...
@AnalyzeClasses(packages = "de.lmoesle.miravelo.processautomationexample", importOptions = {ImportOption.DoNotIncludeTests.class, ExcludeNonModalImportOption.class})
