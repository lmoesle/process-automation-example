...
public final class UserTaskTestdaten {
    ...
    private static final String PROCESS_ID = "vacation_approval";
    ...
    public static Map<String, String> meta() {
        ...
        meta.put("processDefinitionKey", PROCESS_ID);
    ...
    public static Map<String, Object> payload() {
        ...
        payload.put(URLAUBSANTRAG_ID_VARIABLE, UrlaubsantragTestData.VACATION_REQUEST_UUID.toString());
    ...
    public static Map<String, Object> secondPayload() {
        final LinkedHashMap<String, Object> payload = new LinkedHashMap<>();
        payload.put(URLAUBSANTRAG_ID_VARIABLE, UrlaubsantragTestData.SECOND_VACATION_REQUEST_UUID.toString());
