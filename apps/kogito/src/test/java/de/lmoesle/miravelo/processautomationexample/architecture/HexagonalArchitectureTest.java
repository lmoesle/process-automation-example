...
import static de.lmoesle.miravelo.processautomationexample.architecture.ArchUnitUtils.*;

/**
 * Architektur Entscheidung: docs/adrs/ADR_004_nutze-hexagonale-architektur.md
 */
@AnalyzeClasses(
        packages = "de.lmoesle.miravelo.processautomationexample",
        importOptions = {
...
class HexagonalArchitectureTest {
    ...
    static final ArchRule all_classes_must_reside_in_hexagonal_layers =
            classes()
                    ...
                    .should().resideInAnyPackage(
                            "de.lmoesle.miravelo.processautomationexample.domain..",
                            "de.lmoesle.miravelo.processautomationexample.application..",
                            "de.lmoesle.miravelo.processautomationexample.adapter.."
                    )
    ...
    @ArchTest
    static final ArchRule process_adapters_should_not_depend_on_persistence_adapters =
            noClasses()
                    .that().resideInAPackage("..adapter.out.process..")
                    .should().dependOnClassesThat()
                    .resideInAPackage("..adapter.out.persistence..")
                    .because("Outbound adapters must collaborate through application-owned ports");
